...
- <code title="post /api/v1/boxes/{id}/actions/keypress">client.v1.boxes.actions.<a href="./src/resources/v1/boxes/actions.ts">keypress</a>(id, { ...params }) -> ActionResult</code>
