...
export class Actions extends APIResource {
   ...
   * @example
   * ```ts
   * await client.v1.boxes.actions.ai(
   *   'c9bdc193-b54b-4ddb-a035-5ac0c598d32d',
   *   { instruction: 'click the login button' },
   * );
   * ```
   */
  ai(boxID: string, body: ActionAIParams, options?: RequestOptions): APIPromise<void> {
    return this._client.post(path`/boxes/${boxID}/actions/ai`, {
      body,
      ...options,
