...
describe('resource terminal', () => {
  ...
  test.skip('createTerminal', async () => {
    const responsePromise = client.api.v1.gbox.terminal.createTerminal();
  ...
  test.skip('runCommand: only required params', async () => {
    const responsePromise = client.api.v1.gbox.terminal.runCommand({ command: 'ls -l', uid: 'uid-1' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('runCommand: required and optional params', async () => {
    const response = await client.api.v1.gbox.terminal.runCommand({ command: 'ls -l', uid: 'uid-1' });
  });
});
