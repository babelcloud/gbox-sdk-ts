...
describe('resource actions', () => {
  ...
  test.skip('move: only required params', async () => {
    const responsePromise = client.boxes.actions.move('id', { type: 'move', x: 0, y: 0 });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('move: required and optional params', async () => {
    const response = await client.boxes.actions.move('id', { type: 'move', x: 0, y: 0 });
  });
  ...
  test.skip('type: only required params', async () => {
    const responsePromise = client.boxes.actions.type('id', { text: 'text', type: 'type' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('type: required and optional params', async () => {
    const response = await client.boxes.actions.type('id', { text: 'text', type: 'type' });
  });
});
